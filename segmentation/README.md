...
推理
原代码：
python inference.py --config config.json --model saved/UNet/04-12_17-04/checkpoint-epoch70.pth --images /disk2/gitlab/zhangyuechao/ats_module/zhijiaoxuhan/small/test/1/
...
备注：
（1）config 的设置可以参考： exp/*.json
（2）数据加载文件修改：参考 dataloaders/vocself_exp.py
