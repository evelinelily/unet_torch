...
class _PSPModule(nn.Module):
    ...
    def _make_stages(self, in_channels, out_channels, bin_sz, norm_layer):
        if bin_sz == 1:
            ...
            prior = nn.AvgPool2d(kernel_size=(32, 32), stride=(32, 32),ceil_mode=True)
        elif bin_sz == 2:
            prior = nn.AvgPool2d(kernel_size=(16, 16), stride=(16, 16), ceil_mode=True)
        elif bin_sz == 3:
            prior = nn.AvgPool2d(kernel_size=(11, 11), stride=(11, 11), ceil_mode=True)
        else:
            prior = nn.AvgPool2d(kernel_size=(6, 6), stride=(6, 6), ceil_mode=True)
